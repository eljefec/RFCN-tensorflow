...
parser.add_argument('-annotation', type=str, default="/home/eljefec/data/nexet/train_boxes_60c87b87.simple.csv", help="Path to annotation csv")
parser.add_argument('-name', type=str, default="save", help="Directory to save checkpoints")
parser.add_argument('-saveInterval', type=int, default=10000, help='Save model after this number of iterations')
parser.add_argument('-reportInterval', type=int, default=30, help='Repeat after this number of iterations')
parser.add_argument('-displayInterval', type=int, default=60, help='Display after this number of iterations')
